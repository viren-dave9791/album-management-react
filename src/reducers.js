...
const initialCountries = {isFailed: false, data: null, isLoading: false}
...
const initialStates = {isFailed: false, data: null, isLoading: false}
function states(state = initialStates, action) {
    switch (action.type) {
        case "LOAD_STATESS_PENDING":
        return {...state, isFailed: false, data: null, isLoading: true}
        case "LOAD_STATESS":
            return {...state, isFailed: false, data: action.payload, isLoading: false}
        case "LOAD_STATESS_FAILED":
            return {...state, isFailed: true, data: action.payload, isLoading: false}
        default:
            return state
    }
